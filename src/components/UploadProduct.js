...
const UploadProduct = ({
    ...
    return (
        <div className=' bg-slate-200 bg-opacity-40 w-full h-full top-0 left-0 right-0 bottom-0 flex items-center justify-center' >


            <div className="bg-white p-4 rounded w-full max-w-2xl " style={{ height: '80%' }}>
                ...
                <form onSubmit={handleSubmit} className=" mx-auto p-4 bg-white shadow-md rounded">
                                    ...
                                    <div className='flex flex-wrap gap-4'>
                                        {data.productImage.map((item, index) => (
                                            <div key={index} className='flex-shrink-0 relative group'>
                                                ...
                                                />
                                                <div className='absolute bottom-0 right-0 p-1 text-white bg-red-600 rounded-full hidden group-hover:block cursor-pointer ' onClick={() => handledelete(index)}><MdDeleteForever /></div>
                                            </div>
                                        ))}
                                    </div>
                                ) : (
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            type="submit"
                            className="px-3 py-1 bg-red-600 text-white font-bold  w-full hover:bg-red-700 transition-all"
                        >
                            Submit
                        </button>
                    </div>
